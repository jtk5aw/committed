...
///
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), weather_crate_client_sdk::Error> {
/// # let client: weather_crate_client_sdk::Client = unimplemented!();
/// use ::http::header::{HeaderName, HeaderValue};
///
/// let result = client.get_current_time()
///     .customize()
///     .mutate_request(|req| {
