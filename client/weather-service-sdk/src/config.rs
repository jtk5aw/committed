...
/// Configuration for a weather_crate_client_sdk service client.
///
...
impl Builder {
    ...
    /// use weather_crate_client_sdk::config::Config;
    ...
    /// # fn example() {
    /// use std::time::Duration;
    /// use weather_crate_client_sdk::config::{Builder, Config};
    /// use aws_smithy_runtime::client::http::hyper_014::HyperClientBuilder;
    ///
    ...
    /// }
    ///
    /// let mut builder = weather_crate_client_sdk::Config::builder();
    ...
    /// ```no_run
    /// use weather_crate_client_sdk::config::endpoint::{ResolveEndpoint, EndpointFuture, Params, Endpoint};
    /// #[derive(Debug)]
    ...
    /// let config = weather_crate_client_sdk::Config::builder().endpoint_resolver(resolver).build();
    /// let client = weather_crate_client_sdk::Client::from_conf(config);
    /// ```
    ...
    /// ```no_run
    /// use weather_crate_client_sdk::config::Config;
    /// use weather_crate_client_sdk::config::retry::RetryConfig;
    ///
    ...
    ///
    /// ```no_run
    /// use weather_crate_client_sdk::config::{AsyncSleep, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    ...
    ///
    /// ```no_run
    /// use weather_crate_client_sdk::config::{AsyncSleep, Builder, Config, SharedAsyncSleep, Sleep};
    ///
    /// #[derive(Debug)]
    /// pub struct ForeverSleep;
    ///
    ...
    /// # use std::time::Duration;
    /// use weather_crate_client_sdk::config::Config;
    /// use weather_crate_client_sdk::config::timeout::TimeoutConfig;
    ///
    ...
    /// ```no_run
    /// use weather_crate_client_sdk::config::IdentityCache;
    ///
    /// let config = weather_crate_client_sdk::Config::builder()
    ...
    /// ```no_run
    /// use weather_crate_client_sdk::config::BehaviorVersion;
    ///
    /// let config = weather_crate_client_sdk::Config::builder()
    ...
    pub fn build(mut self) -> Config {
        ...
        Config {
            config: crate::config::Layer::from(layer.clone())
                .with_name("weather_crate_client_sdk::config::Config")
                .freeze(),
            cloneable: layer,
    ...
    pub(crate) fn new(
        ...
        Self {
            config: ::aws_smithy_types::config_bag::Layer::from(layer)
                .with_name("weather_crate_client_sdk::config::ConfigOverrideRuntimePlugin")
                .freeze(),
            components,
        }
    }
    ...
    let mut plugins = ::aws_smithy_runtime_api::client::runtime_plugin::RuntimePlugins::new()
                        ...
                        .with_client_plugins(::aws_smithy_runtime::client::defaults::default_plugins(
                            ::aws_smithy_runtime::client::defaults::DefaultPluginParams::new()
                                .with_retry_partition_name("Weather")
